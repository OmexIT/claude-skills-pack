...
## Project Overview
A collection of 43 Claude Code skills covering the full software development lifecycle. Skills range from lightweight methodology guides (~80 lines) to comprehensive multi-agent orchestrators (~700 lines).
...
- **Planning** (13): prd, design-doc, adr, user-flow, flow-map, ui-design, api-design, data-design, search-design, infra-design, ticket-breakdown, experiment-design, decision-matrix, migration-plan
- **Implementation** (4): spec-to-impl, verify-impl, mobile-dev, finalize
- **Quality** (10): pr-review, evidence-review, test-plan, security-review, performance-review, ux-review, docs-review, metrics-review, tech-debt-assessment, debug-triage
