...
- After ANY pattern change, run `python3 hooks/test_hooks.py` - every pattern keeps a paired should-block / should-pass case there. All cases must pass before shipping.
